...
{
    public class MusicManagerController : IController
    {
        ...
        public MusicManagerController(string clientId, string clientSecret)
        {
            http = new Http();
        ...
        /// <summary>
        /// Read-only. The token used to renew the access token. To get the refresh token, see <see cref="MusicManagerController.GetRefreshToken"/>.
        /// </summary>
        public string RefreshToken { get; protected set; }

        /// <summary>
        /// Read-only. The current access token. To renew, see <see cref="MusicManagerController.GetRefreshToken"/>.
        /// </summary>
