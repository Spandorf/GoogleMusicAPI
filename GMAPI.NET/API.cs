...
namespace GoogleMusic
{
    ...
    public class API
    {
        ...
        {
            this.WebClient = new WebController();
            this.MusicManager = new MusicManagerController(clientId, clientSecret);
        }
        ...
        /// </summary>
        public WebController WebClient { get; set; }

        /// <summary>
        /// The underlying MusicManagerClient object of the current API instance.
        /// </summary>
        public MusicManagerController MusicManager { get; set; }
